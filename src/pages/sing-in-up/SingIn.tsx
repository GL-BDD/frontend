    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-200 p-8">
      <div className="signin">
        <div className="signin--information">
          ...
          {successMessage && <p className="text-green-600 bg-green-50 p-3 rounded-lg">{successMessage}</p>}
          {authError && <p className="text-red-600 bg-red-50 p-3 rounded-lg">{authError}</p>}
          <form onSubmit={handleSubmit}>
            ...
            <button className="bleu hover:bg-blue-700 transition-colors duration-200" type="submit" disabled={isLoading}>
