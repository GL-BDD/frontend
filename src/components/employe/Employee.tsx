        ...
        <>
          <div className="employeepage__information">
            ...
            <div className="employeepage--chat">
              ...
              {user?.role === 'artisan' && (
                         <button
                           onClick={() => navigate(`/artisan-dashboard/${idUtilisateur}`)}
                           className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 w-full mt-4"
                         >
                           Dashboard
                         </button>
                       )}
